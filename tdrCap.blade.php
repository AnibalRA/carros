 ...
 <div>
 	...
 	<div>
		...
		?>
 		...
 		<p> La capacitación se llevará a cabo en las instalaciones de la Universidad Católica de El Salvador, Centro Regional de Ilobasco, ubicadas en el Km. 51 ½ Carretera a Ilobasco, Cantón Agua Zarca, Ilobasco, Cabañas el día 
 	...
 	<div>
 		...
 		<p>
 			Fecha límite: 
 				{{date('d', $date2)}} de {{$meses[date('m', $date2) - 1]}} de {{date('Y', $date2)}}. {{$cap->nota}}
